...
# ==============================================================================
# Path to the folder with the original angry dog images
input_dir = "/content/drive/My Drive/Datasets/Angry dogs"

# Path to the destination folder.
output_dir = "/content/drive/My Drive/Datasets/aggressive gray scale"
